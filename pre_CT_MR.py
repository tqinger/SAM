...
nii_path = r"C:\Users\Public\data\FLARE22Train\FLARE22Train\images"  # path to the nii images
gt_path = r"C:\Users\Public\data\FLARE22Train\FLARE22Train\labels"  # path to the ground truth
npy_path = os.path.join(r"C:\Users\Public\data\FLARE22Train\npy",prefix[:-1])
# npy_path = r"C:\Users\Public\data\FLARE22Train\npy" + prefix[:-1]
